...
class Sapphire:
    ...
    def GetQ(detector):
        return 1.0 / utils.LerpArray(sapphireLoss_x, sapphireLoss_y, detector.parameters['temperature'])
...
class Crystal:
    ...
    def GetQ(detector):
        return 1.0 / utils.LerpArray(crystalLoss_x, crystalLoss_y, detector.parameters['temperature'])
...
class Silicon:
    ...
    def GetQ(detector):
        return 1.0 / utils.LerpArray(siliconLoss_x, siliconLoss_y, detector.parameters['temperature'])
...
class Silica:
    ...
    def GetQ(detector):
        return 1.0 / utils.LerpArray(silicaLoss_x, silicaLoss_y, detector.parameters['temperature'])
